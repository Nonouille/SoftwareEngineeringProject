...
app.get('/api/get-students/:id', function (req, res) {
    var studentId = parseInt(req.params.id); // Extract the student ID from the request parameters
    var student = students.find(function (student) { return student.id === studentId; }); // Find the student with the given ID
    if (student) {
...
app.put('/api/modify-student/:id', function (req, res) {
    ...
    if (student.id !== undefined) {
        ...
        var updatedStudent = req.body; // Extract updated student details from the request body
